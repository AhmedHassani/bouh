...
INSERT INTO "ConsultantProfile" (
  id, "userId", bio, city, "yearsOfExperience",
  "sessionPrice", "commissionRate", rating, "totalReviews", "isVerified",
  "createdAt", "updatedAt"
)
SELECT 'cp-' || gen_random_uuid()::text, u.id, NULL, 'بغداد', 0,
       31499, 0.10, 0, 0, true,
       now(), now()
...
INSERT INTO "AnonymousUser" (id, "deviceId", nickname, "createdAt")
VALUES (
...
ON CONFLICT ("deviceId", nickname) DO NOTHING;
